...
namespace Textadventure
{
    public class Character
    {
        ...
        public Dictionary<string, int> learned_regular_attacks = new Dictionary<string, int>
        {
            { "Punch", 5 },
            { "Strike", 5 }, // braucht Waffe
        ...
        public Dictionary<string, int> learned_support_attacks = new Dictionary<string, int>
        {              
            { "Trap", 1 },
            { "Ensnare", 2 }, 
