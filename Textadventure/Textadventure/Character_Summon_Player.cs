...
{
    public class Character_Summon_Player : Character_Player
    {
        public int duration_left { get; set; }
        public string duration_string { get; set; }
        public Character_Summon_Player()
        {
        ...
        public Character_Summon_Player(string @class, string race, string name)
        {
