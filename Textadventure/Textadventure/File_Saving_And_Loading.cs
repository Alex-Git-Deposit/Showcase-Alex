                    ...
                    else
                    {
                        switch (parts[1])
                        {
                            case "character data":
                                ...
                                current_player_loading.spells = new Spell();
                                current_player_loading.special_attacks = new Special_Attack();
                                current_player_loading.regular_attacks = new Regular_Attack();
                                current_player_loading.support_attacks = new Support_Attack();
