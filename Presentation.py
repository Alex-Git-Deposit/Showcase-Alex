...
# Meine Konstanten
window_title_ppt = "Vorstellung Alexander V2 - PowerPoint"
window_title_script = "Presentation.py - Visual Studio Code [Administrator]"
window_title_server = "My chat Server"
window_title_client = "My chat client"
window_title_console_snake = "C:\\Users\\FP2402389\\source\\repos\\Snake\\bin\\Debug\\net8.0-windows\\Snake.exe"
window_title_snake = "Snake" # wird nicht richtig erkannt
window_title_tetris = "Tetris"
window_title_ta = "Textadventure - Microsoft Visual Studio"

# Eröffnung der Presentation: Zeit einplanen
actions_set_1 = [
    {"type": "function", "function": minimize_window, "parameters": [window_title_script], "pause": 0.5},
    {"type": "function", "function": set_mouse_position_in_window, "parameters": [window_title_ppt, 100, 200, None, True], "pause": 2},
    {"type": "function", "function": set_mouse_position_in_window, "parameters": [window_title_ppt, 100, 320, None, True], "pause": 2},
    {"type": "function", "function": set_mouse_position_in_window, "parameters": [window_title_ppt, 100, 450, None, True], "pause": 2},
    {"type": "function", "function": minimize_window, "parameters": [window_title_ppt], "pause": 1},
]
# Chat Programm zeigen

actions_set_2 = [
    {"type": "function", "function": restore_window_by_title_and_index, "parameters": [window_title_server], "pause": 0.2},
...
actions_set_3 = [
    {"type": "function", "function": perform_mouse_action_in_window_mit_index, "parameters": [window_title_client, 0, {"type": "mouse", "x": 500, "y": 180, "click": True, "pause": 0.5}], "pause": 0.5},
    {"type": "function", "function": perform_mouse_action_in_window_mit_index, "parameters": [window_title_client, 1, {"type": "mouse", "x": 500, "y": 180, "click": True, "pause": 0.5}], "pause": 0.5},
    {"type": "function", "function": perform_mouse_action_in_window_mit_index, "parameters": [window_title_client, 2, {"type": "mouse", "x": 500, "y": 180, "click": True, "pause": 0.5}], "pause": 0.5},
    {"type": "function", "function": perform_mouse_action_in_window_mit_index, "parameters": [window_title_client, 2, {"type": "mouse", "x": 200, "y": 360, "click": True, "pause": 0.5}], "pause": 0.5},
...
actions_set_7 = [
    ...
    {"type": "function", "function": set_mouse_position_in_window, "parameters": [window_title_tetris, 650, 450, None, True], "pause": 1},
]
# Tetris ausführen
actions_set_8 = [
    {"type": "key", "key": VK_DOWN, "pause": 0.2},
...
# Tetris minimieren
actions_set_9 = [
    {"type": "function", "function": minimize_window, "parameters": [window_title_tetris], "pause": 2}
]
# TA demonstrieren
actions_set_10 =[
    {"type": "function", "function": set_mouse_position_in_window, "parameters": [window_title_ta, 500, 50, None, True], "pause": 0.5}
]
...
def main():  
    ...
    execute_actions_with_loop(actions_set_4, 10) # Loop
    ...
    execute_actions_with_loop(actions_set_8, 2) # Tetris spielen
